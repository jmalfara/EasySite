...
<title> Download | <?php writeTitle();?> Apk </title>
...
<div class="container" style="min-width:  1170px;">
	<div class="header">
		<h1 class="headerText" >Apk Download | <?php writeTitle(); ?></h1>
	</div>
	<?php addMenuBar(); ?>
	<table class="content">
		<td class="leftSideBar"> 
			...
			<div> 
				<?php createDownloadButton("Download APK Here"); ?>
			</div>
		...
		<td class="rightSideBar">
			...
			<div class="infoDiv" id="text" style="overflow-y: scroll; height:400px;"> <?php writeDescription(); ?></div>
