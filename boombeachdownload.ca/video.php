...
<title> App Trailer | <?php writeTitle();?> Apk </title>
<?php writeOtherMeta("ids/video.bio"); ?>
...
<div class="container" style="min-width:  1170px;">
	<div class="header">
		<h1 class="headerText" >App Trailers | <?php writeTitle(); ?></h1>
	</div>
	<?php addMenuBar(); ?>
	<table class="content">
		...
		<td class="rightSideBar">
			<div class="infoDiv"><h2>App Trailer:</h2></div>
			<div class="infoDiv"> <?php getVideoLink(); ?></div>
		</td>
	</table>
	<div class="footer">
