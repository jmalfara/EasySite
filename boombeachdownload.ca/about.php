...
<title> About | <?php writeTitle();?> Apk </title>
<?php writeOtherMeta("/ids/about.bio"); ?>
...
<div class="container" style="min-width:  1170px;">
	<div class="header">
		<h1 class="headerText" >About Us | <?php writeTitle(); ?></h1>
	</div>
	<?php addMenuBar(); ?>
	<table class="content">
		...
		<td class="rightSideBar">
			<div class="infoDiv"><h2>About Us:</h2></div>
			<div class="infoDiv"> <?php writeAboutBio(); ?></div>
		</td>
	</table>
	<div class="footer">
