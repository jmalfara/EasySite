...
<title> Contact Us | <?php writeTitle();?> Apk </title>
<?php writeOtherMeta("/ids/contact.bio"); ?>
...
<div class="container" style="min-width:  1170px;">
	<div class="header">
		<h1 class="headerText" >Contact Us | <?php writeTitle(); ?></h1>
	</div>
	<?php addMenuBar(); ?>
	<table class="content">
		...
		<td class="rightSideBar">
			...
			<div class="infoDiv"> <?php writeContactBio(); ?> <br> <br> <?php writeContactForm(); ?></div>
		</td>
	</table>
	<div class="footer">
